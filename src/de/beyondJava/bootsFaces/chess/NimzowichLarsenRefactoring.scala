...
class NimzovichLarsenRefactoring extends Simulation {
  ...
  val start = http("request_0")
    .get("/BootsFacesChess/")
    .headers(headers_0);
  
  val move1 = http("request_1")
  ...
  def doMove(id:String, move:String) = {
    http(id)
      .post("/BootsFacesChess/index.jsf")
      .headers(headers_1)
      .formParam("input_form:j_id_y", "5")
      ...
      .formParam(move, move)
      .formParam("javax.faces.partial.event", "click")
      .formParam("javax.faces.source", move)
      .formParam("javax.faces.partial.ajax", "true")
      .formParam("javax.faces.partial.execute", "form")
      .formParam("javax.faces.partial.render", "form messages")
      .formParam("form", "form")
  ...
  val move9 = doMove("request_25", "form:rows:6:fields:4:j_id_n")
